 ...
 * la semana que fue el primero de enero de dicho año, y muestre por pantalla el
 * día de la semana que corresponde a la fecha que le hemos dado. En la
 * resolución deben considerarse los años bisiestos. Se resolverá usando la
...
public class Ejercicio048 {
    ...
    public void ejercicio() {
        ...
        dia = Integer.parseInt(Mensajes.pedirDatos("Introduzca el valor numérico para el día",
                "Petición de Datos", Mensajes.TipoMensaje.PREGUNTA));

        mes = Integer.parseInt(Mensajes.pedirDatos("Introduzca el valor numérico para el mes",
                "Petición de Datos", Mensajes.TipoMensaje.PREGUNTA));

        anyo = Integer.parseInt(Mensajes.pedirDatos("Introduzca el valor numérico para el año",
                "Petición de Datos", Mensajes.TipoMensaje.PREGUNTA));
