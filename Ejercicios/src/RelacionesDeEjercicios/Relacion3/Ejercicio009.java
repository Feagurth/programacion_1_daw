 ...
 * están recogidas en la hoja de cálculo. Calcula las medidas de 
 * centralización y de dispersión.
 *      a. Indicaciones:
 *          I. Crearos una clase llamada DistribuciónEstadistica con los 
 *          siguientes elementos:
 *              1. Crearos un campo de clase que almacene las notas del centro. 
 *              Podéis generar de forma aleatoria los datos.
 *              2. Métodos de la clase  implementan cada una de las medidas 
